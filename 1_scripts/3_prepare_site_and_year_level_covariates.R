...
# need to structure data as site-level, yearly-level, and observation-level covariates
...
write.csv(veghf.1993, "0_data/processed/Calling Lake/site.cov.csv")

#Detection covariates 
recast.julian<-read.csv("0_data/processed/Calling Lake/8_rearranged.julian.csv",header=TRUE)
recast.jcen<-read.csv("0_data/processed/Calling Lake/10_rearranged.jcen.csv",header=TRUE)
recast.jcen2<-read.csv("0_data/processed/Calling Lake/12_rearranged.jcen2.csv",header=TRUE)
recast.time<-read.csv("0_data/processed/Calling Lake/14_rearranged.time.csv",header=TRUE)
recast.tcen<-read.csv("0_data/processed/Calling Lake/16_rearranged.tcen.csv",header=TRUE)
recast.tcen2<-read.csv("0_data/processed/Calling Lake/18_rearranged.tcen2.csv",header=TRUE)
...
yearly.cov<-data.frame(autolog.250, y.prop565.harvest, logged150.s,logged_1sqk.s,seismic150.s,seismic_1sqk.s,
